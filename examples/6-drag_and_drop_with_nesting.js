...
var DragDropWithNestingTree = /** @class */ (function (_super) {
    ...
    DragDropWithNestingTree.prototype.render = function () {
        ...
        <navigation_1["default"]>
          <src_1["default"] tree={tree} renderItem={this.renderItem} onExpand={this.onExpand} onCollapse={this.onCollapse} onDragEnd={this.onDragEnd} isDragEnabled isNestingEnabled/>
        </navigation_1["default"]>
      </Container>);
    };
